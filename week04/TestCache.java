...
public class TestCache {
  public static void main(String[] args) throws InterruptedException {
    ...
    final int threadCountOuter = 1;
    Mark7(String.format("TestCacheMemoizer %6d", threadCountOuter), 
          i -> TestCacheMemoizer(threadCount));
  ...
  private static long TestCacheMemoizer(int threadCount) {
    Factorizer myF1 = new Factorizer();
    Memoizer5<Long,long[]> cachingFactorizerM1 = new Memoizer5<Long,long[]>(myF1);
    exerciseFactorizer(cachingFactorizerM1, threadCount);
    return myF1.getCount();
    // System.out.println("For cachingFactorizerM1, myF1.getCount() is: " + myF1.getCount());
  }
  ...
  // Exercise 2.4, 1
  private static void exerciseFactorizer(Computable<Long, long[]> f, int threadCount) {
    // final int threadCount = 16;
